  ...
  <div class="footer">
   ...
   <script>
      ...
      function processOrder() {
        ...
        // updateCart() 함수가 계산한 총액을 가져오기
        var totalPriceElement = document.getElementById('total-price');
        var totalPriceText = totalPriceElement.innerText;
        var totalAmount = 0;
        
        console.log('=== processOrder 디버깅 ===');
        console.log('totalPriceText:', totalPriceText);
        
        // "총 결제 금액: ₩123,456" 형식에서 숫자만 추출
        var priceMatch = totalPriceText.match(/₩([0-9,]+)/);
        ...
        console.log('추출된 totalAmount:', totalAmount);
        ...
        console.log('선택된 상품 개수:', selectedCheckboxes.length);
        console.log('선택된 CART_IDs:', selectedCartIds);
        console.log('=== processOrder 디버깅 끝 ===');

        // 결제 확인
        if (confirm('선택된 상품을 주문하시겠습니까?')) {
          // 선택된 상품들의 CART_ID를 URL 파라미터로 전달하여 orderAction3.jsp로 이동
